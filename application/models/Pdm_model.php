...
class Pdm_model extends CI_Model
{
  ...
  function get_all_transaksi_individu()
  {
    ...
    $this->db->where('transaksi_individu.id_program', '5');
    $query = $this->db->get();
    return $query->row();
  }
  ...
  function get_detail_komunitas_by_id($id)
  {
    ...
    $this->db->where('transaksi_komunitas.id_program', '5');
  ...
  {
    $this->db->select('*,transaksi_komunitas_d.nik as nik_det');
  ...
  {
    $this->db->select('*, transaksi_komunitas_d.nik as nik_transaksi');
    $this->db->from('transaksi_komunitas');    
  ...
  function get_data_komunitas_by_program()
  {
    $sql = "SELECT
            ...
            WHERE `b`.`id_kategori_komunitas` = 1 OR `b`.`id_kategori_komunitas` = 3
            ";
