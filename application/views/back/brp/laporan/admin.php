								...
								<div class="row">
									<div class="col-md-12">
										<ul class="nav nav-tabs">
											<li class="nav-item">
												<a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true"> Laporan Individu </a>
											</li>
											<li class="nav-item">
												<a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2" href="#tab2" aria-expanded="false"> Laporan Komunitas </a>
											</li>
										</ul>
															...
															foreach ($individu as $data) { ?>
																<tr>
																	...
																	<td class="text-center">
																		<a href="<?php echo base_url('brp/detail_laporan_individu/' . $data->nik . '/' . $data->total_periode) ?>" class="btn btn-primary btn-sm" title="Detail"><span><i class="fa fa-eye"></i></span> </a>
																	</td>
																</tr>
															<?php
																$no += 1;
														...
														<tbody>
															...
															foreach ($komunitas as $data) { ?>
																<tr>
																	...
																	<td><?php echo ucwords($data->nama_pasien) ?></td>
																	...
																	<td><?php echo $data->kelurahan_pasien ?></td>
																	<td><?php echo $data->kecamatan_pasien ?></td>
																	<td><?php echo $data->kesan_pasien ?></td>
