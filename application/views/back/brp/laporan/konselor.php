											...
											<div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="row">
															<div class="col-lg-6">
																<h5>Rekap berdasarkan Provinsi</h5>
															...
															<div class="col-lg-6">
																<h5>Rekap berdasarkan Jenis Kelamin</h5>
																<table class="table table-bordered">
																	<thead class="thead-light">
																		<tr>
																			<th>No</th>
															...
															foreach ($individu as $data) { ?>
																<tr>
																	...
																	<td class="text-center">
																		<a href="<?php echo base_url('brp/detail_laporan_individu/' . $data->nik . '/' . $data->total_periode) ?>" class="btn btn-primary btn-sm" title="Detail"><span><i class="fa fa-eye"></i></span>
																		</a>
																	</td>
																</tr>
															<?php
											...
											<div class="tab-pane" id="tab2" aria-labelledby="base-tab2">
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="row">
															<div class="col-lg-6">
																<h5>Rekap Berdasarkan Rumah Sakit</h5>
																<table class="table table-bordered">
																	<thead class="thead-light">
																		<tr>
																			<th>No</th>
																			<th>Rumah Sakit</th>
																			<th>Jumlah Pasien LK</th>
																			<th>Jumlah Pasien PR</th>
																			<th>Total Jumlah Pasien</th>
																		</tr>
																	</thead>
																	<tbody>
																		<?php $i = 1;
																		foreach ($total_rumah_sakit as $row) : ?>
																			<tr>
																				<td><?= $i; ?></td>
															...
															<div class="col-lg-6">
																<h5>Rekap Berdasarkan Jenis Penyakit</h5>
																<table class="table table-bordered">
																	<thead class="thead-light">
																		<tr>
																			<th>No</th>
																	...
																	<tbody>
																		<?php $i = 1;
																		foreach ($total_jenis_penyakit as $row) : ?>
																			<tr>
																				<td><?= $i; ?></td>
													...
													<div class="col-lg-12">
														<div class="row">
															...
															<div class="col-lg-6">
																<h5>Rekap Berdasarkan Petugas Bimroh</h5>
																<table class="table table-bordered">
																	<thead class="thead-light">
																		<tr>
																			<th>No</th>
																			<th>Rumah Sakit</th>
																			<th>Petugas Bimroh</th>
																	...
																	<tbody>
																		<?php $i = 1;
																		foreach ($total_nama_komunitas as $row) : ?>
																			<tr>
																				<td><?= $i; ?></td>
																				<td><?= $row['nama_komunitas'] ?></td>
																				<td>-</td>
														...
														<tbody>
															...
															foreach ($komunitas as $data) { ?>
																<tr>
																	...
																	<td><?php echo $komunitas_d[$no - 1]->ruang_perawatan ?></td>
																	<td><?php echo $komunitas_d[$no - 1]->kls_kamar ?></td>
																	<td><?php echo $data->alamat ?></td>
																	<td>
																	...
																	<td><?php echo $komunitas_d[$no - 1]->kesan ?></td>
																	<td>
																		<a href="<?php echo base_url('brp/detail_laporan_komunitas/' . $data->nik_transaksi . '/' . $data->total_periode) ?>" class="btn btn-primary btn-sm" title="Detail">
