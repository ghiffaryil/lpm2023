                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <fieldset class="form-group ditolak">
                                      ...
                                      <input type="date" class="form-control text-capitalize " name="periode_bantuan" id="periode_bantuan">
                                    </fieldset>
                                  </div>
                                  <div class="col-md-6">
                                    <fieldset class="form-group">
                                      <p>Total Periode</p>
                                      <input type="text" class="form-control text-capitalize  " name="total_periode" id="total_periode" value="<?php echo (int)$cek_individu + 1 ?>" readonly>
                                    </fieldset>
                                  </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <!-- <fieldset class="form-group mb-1">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" oninput="formatValue('jumlah_permohonan_komunitas')"
                                      id="jumlah_permohonan_komunitas" name="jumlah_permohonan" value="0"
                                      aria-describedby="basic-addon1" class="form-control">
                                  </div>
                                </fieldset> -->
                                <fieldset class="form-group">
                                  <p>Tgl Kunjungan</p>
                                  <input type="date" class="form-control text-capitalize" id="tgl_kunjungan" name="tgl_kunjungan">
                                </fieldset>
                              ...
                              <div class="col-md-6">
                                ...
                                <fieldset class="form-group">
                                  ...
                                  <i>Data ini akan terisi otomatis setelah menginput Nama Penerima</i>
                                </fieldset>
                                ...
                                <fieldset class="form-group">
                                  <p>Kunjungan Ke</p>
                                  <input type="text" class="form-control text-capitalize" name="kunjungan" id="kunjungan">
                                </fieldset>
                                <fieldset class="form-group">
                                  <p>Jenis Bantuan</p>
                                  <input type="text" class="form-control text-capitalize" id="jenis_bantuan" name="jenis_bantuan">
                                      ...
                                      <div class="col-md-12 mb-1">
                                        <div class="row">
                                          ...
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>Usia</p>
                                              <input type="text" class="form-control text-capitalize" name="usia" id="usia" value="">
                                            </fieldset>
                                          </div>
                                        </div>
                                        <div class="row">
                                          ...
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>Jenis Penyakit</p>
                                              <input type="text" class="form-control text-capitalize" name="jenis_penyakit" id="jenis_penyakit" value="">
                                            </fieldset>
                                          </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>Ruang Perawatan </p>
                                              <input type="text" class="form-control text-capitalize" id="ruang_perawatan" name="ruang_perawatan" value="">
                                            </fieldset>
                                          </div>
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>KLS</p>
                                              <input type="text" class="form-control text-capitalize" name="kls_kamar" id="kls_kamar" value="">
                                            </fieldset>
                                          </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>Alamat Rumah</p>
                                              <textarea type="text" rows="1" class="form-control text-capitalize" id="alamat" name="alamat"></textarea>
                                            </fieldset>
                                          </div>
                                          ...
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>Kelurahan</p>
                                              <input type="text" class="form-control text-capitalize" name="kelurahan" id="kelurahan" value="">
                                            </fieldset>
                                          </div>
                                        </div>
                                        <div class="row">
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>Kecamatan </p>
                                              <input type="text" class="form-control text-capitalize" id="kecamatan" name="kecamatan" value="">
                                            </fieldset>
                                          </div>
                                          <div class="col-md-6">
                                            <fieldset class="form-group">
                                              <p>KOTA/KAB</p>
                                              <input type="text" class="form-control text-capitalize" name="kota" id="kota" value="">
                                            </fieldset>
                                          </div>
                                        </div>
                                        <fieldset class="form-group">
                                          <p>Kesan Pasien</p>
                                          <input type="text" class="form-control text-capitalize" name="kesan" id="kesan" value="">
                                        </fieldset>
                                      </div>
                                    </div>
                                  </div>
...
<script type="text/javascript">
  ...
  $(document).on('click', '#tambahitem', function(e) {
    ...
    tempRow += "<td>" + Nama + "</td><td>" + usia + "</td><td>" + jeniskelamin + "</td><td>" + jenispenyakit + "</td>";
