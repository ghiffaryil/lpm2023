                        ...
                        <div class="row">
                          <div class="col-md-6 mb-2">
                            ...
                            <!-- <fieldset class="form-group">
                              ...
                              <fieldset class="form-group">
                                  <p>Tgl Kunjungan</p>
                                  <input type="date" class="form-control text-capitalize" id="tgl_kunjungan"
                                    name="tgl_kunjungan"  value="<?php echo $data->periode_bantuan ?>">
                                </fieldset> 
                          ...
                          <div class="col-md-6">
                            ...
                            <fieldset class="form-group">
                              <p>Kunjungan Ke</p>
                              <input type="text" class="form-control text-capitalize" name="kunjungan" id="kunjungan" value="<?php echo $data->kunjungan ?>">
                            </fieldset>
                            <fieldset class="form-group">
                                  <p>Jenis Bantuan</p>
                                  ...
                                  <div class="col-md-12 mb-1">
                                    <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        <fieldset class="form-group">
                                          <p>Usia</p>
                                          <input type="text" class="form-control text-capitalize" name="usia" id="usia"
                                            value="">
                                        </fieldset>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-md-6">
                                        <fieldset class="form-group">
                                          <p>Jenis Kelamin </p>
                                          <input type="text" class="form-control text-capitalize" name="jenis_kelamin"
                                            id="jenis_kelamin">
                                      ...
                                      <div class="col-md-6">
                                        <fieldset class="form-group">
                                          <p>Jenis Penyakit</p>
                                          <input type="text" class="form-control text-capitalize" name="jenis_penyakit"
                                            id="jenis_penyakit" value="">
                                        </fieldset>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-md-6">
                                        <fieldset class="form-group">
                                          <p>Ruang Perawatan </p>
                                          <input type="text" class="form-control text-capitalize" id="ruang_perawatan"
                                            name="ruang_perawatan" value="">
                                        </fieldset>
                                      </div>
                                      <div class="col-md-6">
                                        <fieldset class="form-group">
                                          <p>KLS</p>
                                          <input type="text" class="form-control text-capitalize" name="kls_kamar"
                                            id="kls_kamar" value="">
                                        </fieldset>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        <fieldset class="form-group">
                                          <p>KOTA/KAB</p>
                                          <input type="text" class="form-control text-capitalize" name="kota" id="kota"
                                            value="">
                                        </fieldset>
                                      </div>
                                    </div>
                                    <fieldset class="form-group">
                                      <p>Kesan Pasien</p>
                                      <input type="text" class="form-control text-capitalize" name="kesan" id="kesan"
                                        value="">
                                    </fieldset>
                                  </div>
                                </div>
                              ...
                              <div class="card-body">
                                ...
                                <table class="table" id="tabelisian">
                                  ...
                                  <tbody>
                                    ...
                                    <tr role="row" id='tr-<?php echo $det->nama_det ?>'>
                                    <input type='hidden' value='<?php echo $det->id_trans_komunitas_d ?>' name='uiddet[]'/>
