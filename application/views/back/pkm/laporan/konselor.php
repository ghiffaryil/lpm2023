													...
													<table id="tabel-individu" class="table table-striped nowrap" width="100%">
														<thead>
															<tr>
																...
																<th>Kota</th> <!-- 5 -->
																<th>ProVinsi</th> <!-- 6 -->
																<th>Jenis Bantuan</th> <!-- 7 -->
																<th>(Rp) Bantuan</th> <!-- 7 -->
																<th>Kasus</th> <!-- 7 -->
																<th>Yang Menyalurkan</th> <!-- 8 -->
																<th>SIFAT</th> <!-- 9 -->
																<th>Nama Sekolah</th> <!-- 9 -->
																<th>Created at</th> <!-- 9 -->
																<th>Action</th> <!-- 9 -->
															</tr>
														</thead>
														<tbody>
															...
															foreach ($individu as $data) { ?>
																<tr>
																	...
																	<td><?php echo $data->sifat_bantuan ?></td>
