											            ...
											            <tr>
											                ...
											                <td>
											                	<?php if ($data->status == '0') { ?>
											                		<a href="<?php echo base_url('pkm/update_individu/'.$data->id_transaksi_individu) ?>" class="btn btn-success btn-sm"><span><i class="fa fa-pencil"></i> Edit</span></a>
																	<a href="<?php echo base_url('pkm/delete/'.$data->id_transaksi_individu) ?>" class="btn btn-danger btn-sm"><span><i class="fa fa-trash"></i> Delete</span></a>
											                	<?php }else{ ?>
