                          ...
                          <div class="col-md-6 mb-2">
                            ...
                            <fieldset class="form-group" hidden>
                              ...
                              <input type="text" class="form-control" name="sifat_bantuan"
                                value="<?php echo $data->sifat_bantuan ?>" readonly>
                            </fieldset>
                            <fieldset class="form-group">
                              <p>Sumber Dana</p>
                            ...
                            <fieldset class="form-group">
                              ...
                              <input type="text" class="form-control text-capitalize" id="penyalur" name="penyalur"
                                value="<?php echo $data->penyalur ?>">
                            </fieldset>
                            <div class="row">
                              <div class="col-md-6">
                                <fieldset class="form-group">
                                  <p>Periode Menerima Manfaat</p>
                                  <input type="date"  data-date-format="yyyy-mm-dd" class="form-control text-capitalize" id="periode_bantuan"
                          ...
                          <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-1">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" oninput="formatValue('jumlah_permohonan_individu')"
                                  id="jumlah_permohonan_individu" name="jumlah_bantuan" value="<?php echo $data->jumlah_bantuan ?>"
                            ...
                            <fieldset class="form-group">
                              ...
                              <select class="form-control selectpicker" name="asnaf" required>
                                ...
                                <option value="Mualaf" <?php if ($data->asnaf == 'Mualaf') {echo "selected";}else{echo "";}?>>Mualaf</option>
                                <option value="Ghorimin" <?php if ($data->asnaf == 'Ghorimin') {echo "selected";}else{echo "";}?>>Ghorimin</option>
                                <option value="Fisabilillah" <?php if ($data->asnaf == 'Fisabilillah') {echo "selected";}else{echo "";}?>>Fisabilillah</option>
                                <option value="Ibnu Sabil" <?php if ($data->asnaf == 'Ibnu Sabil') {echo "selected";}else{echo "";}?>>Ibnu Sabil</option>
                                <option value="Fakir Miskin" <?php if ($data->asnaf == 'Fakir Miskin') {echo "selected";}else{echo "";}?>>Fakir Miskin</option>
                              </select>
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                              ...
                              <select class="form-control selectpicker" name="id_subprogram">
                                ...
                                <option class="text-capitalize" value="<?php echo $row->id_subprogram ?>" <?php if ($row->id_subprogram == $data->id_subprogram) {echo "selected";}else{echo "";}?>>
