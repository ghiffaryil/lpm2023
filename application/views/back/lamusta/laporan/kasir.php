			                            			...
			                            			<div class="row">
					                            		<div class="col-lg-6">
					                            			<table class="table table-bordered">
					                            				...
					                            				<tbody>
					                            				<?php foreach($total_individu_asnaf as $row){ ?>
						                            				<tr>
						                            					<td><?php echo $row->asnaf ?></td>
						                            					<td align="center"><?php echo $row->total_pm ?></td>
						                            					<td>Rp. <span class="float-right"><?php echo number_format($row->total_nominal) ?></span></td>
						                            				</tr>
					                            				<?php } ?>
					                            				</tbody>
					                            			</table>
					                            		...
					                            		<div class="col-lg-6">
					                            			<table class="table table-bordered">
					                            				...
					                            				<tbody>
					                            				<?php foreach($total_individu_prov as $row){ ?>
						                            				<tr>
						                            					<td><?php echo ucwords($row->provinsi)  ?></td>
						                            					<td align="center"><?php echo $row->total_pm ?></td>
						                            					<td>Rp. <span class="float-right"><?php echo number_format($row->total_nominal) ?></span></td>
						                            				</tr>
					                            				<?php } ?>
			                            			...
			                            			<div class="row">
					                            		<div class="col-lg-6">
					                            			<table class="table table-bordered">
					                            				...
					                            				<tbody>
					                            				<?php foreach($total_komunitas_asnaf as $row){ ?>
						                            				<tr>
						                            					<td><?php echo $row->asnaf ?></td>
						                            					<td align="center"><?php echo $row->total_pm ?></td>
						                            					<td>Rp. <span class="float-right"><?php echo number_format($row->total_nominal) ?></span></td>
					                            		...
					                            		<div class="col-lg-6">
					                            			<table class="table table-bordered">
					                            				...
					                            				<tbody>
					                            				<?php foreach($total_komunitas_prov as $row){ ?>
						                            				<tr>
						                            					<td><?php echo ucwords($row->provinsi)  ?></td>
						                            					<td align="center"><?php echo $row->total_pm ?></td>
						                            					<td>Rp. <span class="float-right"><?php echo number_format($row->total_nominal) ?></span></td>
	...
	$(document).ready(function() {
	    ...
	    var table = $('#tabel-individu').DataTable({
	    	...
	    	"footerCallback" : function (row, data, start, end, display) {
	            ...
	            //$('#total').html(api.column(35,{page:'current'}).data().reduce(function(a, b){return intVal(a)+intVal(b);},0).toLocaleString());

	            total = (api.column(35,{page:'current'})
	            			.data()
	            			.reduce(function(a,b){
	    ...
	    var charts4 = Highcharts.chart('chart4', {
	        chart: {
		        type: 'pie'
	        },
	        title: {
