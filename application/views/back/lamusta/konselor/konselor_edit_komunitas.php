                            ...
                            <div class="col-md-6 mb-2">
                              ...
                              <fieldset class="form-group">
                                ...
                                <select type="text" class="form-control selectpicker" style="width: 100%" id="id_komunitas" name="id_komunitas">
                                  ...
                                  <?php foreach($komunitas as $row) { ?>
                                    <option class="text-capitalize" value="<?php echo $row->id_komunitas ?>" <?php if ($data->id_komunitas == $row->id_komunitas){echo "selected";} ?>>
                              ...
                              <fieldset class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" oninput="formatValue('jumlah_permohonan')" id="jumlah_permohonan" name="jumlah_permohonan" value="<?php echo number_format($data->jumlah_permohonan) ?>" aria-describedby="basic-addon1" class="form-control">
                                </div>
                              </fieldset>                              
