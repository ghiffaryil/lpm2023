              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title text-uppercase">Approval Transaksi Individu</div>
                  </div>
                  <div class="card-content">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body">
                              <?php echo form_open_multipart($action_approval_individu) ?>
                                                ...
                                                <div class="form-group float-right">
                                                    <span class="badge badge-success">
                                                        <div class="icheck-primary icheck-inline m-2">
                                                            <input type="radio" class="checkbox1 win" id="win" name="status" value="2" required>
