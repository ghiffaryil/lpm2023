								                    ...
								                    <tbody>
											            ...
											            <tr>
											                ...
											                <td class="text-center">
											                	<a href="<?php echo base_url('lamusta/detail_approval_individu/'.$data->nik) ?>" class="btn btn-primary btn-sm" title="Detail"><span><i class="fa fa-eye"></i></span>
											                	</a> 
											                </td>
											                <td class="text-center">
			                            	...
			                            	<table class="table datatable table-striped nowrap" width="100%">
							                    ...
							                    <tbody>
										            ...
										            <tr>
												        ...
												        <td>
											                <a href="<?php echo base_url('lamusta/detail_admin_komunitas/'.$data->nik) ?>" class="btn btn-primary btn-sm" title="Detail"><span><i class="fa fa-eye"></i></span>
											                </a> 
											            </td>
											            <td class="text-center">
	...
	<script type="text/javascript">
		function approve<?php echo $row->id_transaksi_individu ?> (){
			Swal.fire({
	            ...
	            if (result.isConfirmed) {
	              window.location.href="<?php echo base_url('lamusta/action_approval_individu/'.$row->id_transaksi_individu)?>";
	            }
	        }) 
		}
		function reject<?php echo $row->id_transaksi_individu ?> (){
			Swal.fire({
	            ...
	            if (result.isConfirmed) {
	              window.location.href="<?php echo base_url('lamusta/action_reject_individu/'.$row->id_transaksi_individu)?>";
	            }
	        }) 
		}
	</script> 
	...
	<script type="text/javascript">
		function approve_komunitas<?php echo $row->id_transaksi_komunitas ?> (){
			Swal.fire({
	            ...
	            if (result.isConfirmed) {
	              window.location.href="<?php echo base_url('lamusta/action_approval_komunitas?id_transaksi_komunitas='.$row->id_transaksi_komunitas.'&status=2')?>";
	            }
	        }) 
		}
		function reject_komunitas<?php echo $row->id_transaksi_komunitas ?> (){
			Swal.fire({
	            ...
	            if (result.isConfirmed) {
	              window.location.href="<?php echo base_url('lamusta/action_approval_komunitas?id_transaksi_komunitas='.$row->id_transaksi_komunitas.'&status=4')?>";
	            }
	        }) 
		}
	</script> 
