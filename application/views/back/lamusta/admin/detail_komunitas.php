				...
				<div class="col-md-12">
									<ul class="list-group list-group-unbordered mb-3 table-hover">
										...
										<li class="list-group-item">
											...
											<span class="float-right">
												<?php foreach($get_all_kelurahan as $row){
													if($komunitas[0]->id_desa_kelurahan == $row->id_desa_kelurahan){
				                                      echo $row->desa_kelurahan;
				                                    }
				                                } ?>
											</span>
										...
										<li class="list-group-item">
											...
											<span class="float-right">
												<?php foreach($get_all_kecamatan as $row){
													if($komunitas[0]->id_kecamatan == $row->id_kecamatan){
				                                      echo $row->kecamatan_name;
				                                    }
				                                } ?>
											</span>
										...
										<li class="list-group-item">
											...
											<span class="float-right">
												<?php foreach($get_all_kabupaten as $row){
													if($komunitas[0]->id_kota_kab == $row->id_kota_kab){
				                                      echo $row->kota_kab;
				                                    }
				                                } ?>
											</span>
										...
										<li class="list-group-item">
											...
											<span class="float-right">
												<?php foreach($get_all_provinsi as $row){
													if($komunitas[0]->id_provinsi == $row->id_provinsi){
				                                      echo $row->provinsi;
				                                    }
				                                } ?>
											</span>
										...
										<li class="list-group-item">
											<b>Negara</b>
											<span class="float-right">
												<?php echo $komunitas[0]->negara; ?>
											</span>
										</li>
										<li class="list-group-item">
											<b>Kode Pos</b>
											<span class="float-right">
												<?php echo $komunitas[0]->kodepos; ?>
											</span>
										</li>
									</ul>
							</div>
