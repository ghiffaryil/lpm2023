                ...
                <div class="card">
                  ...
                  <div class="card-content">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="card-body">
                              <?php echo form_open_multipart($action_admin_individu) ?>
                                    ...
                                    <div class="row">
                                      <div class="col-md-6 mb-2">
                                        ...
                                        <fieldset class="form-group mb-1 ml-1 ditolak" <?php if ($data->rekomendasi_bantuan == 'Ditolak'){echo "hidden";} ?>>
                                          <p>Sumber Dana</p>     
                                          <div class="input-group">
                                            <select type="text" class="form-control selectpicker" id="sumber_dana" name="sumber_dana" required>
                                              <option value="" <?php if($data->sumber_dana == ''){echo "selected disabled";} ?>>Silahkan pilih</option>
                                              <option value="Zakat" <?php if($data->sumber_dana == 'Zakat'){echo "selected";} ?>>Zakat</option>
                                              <option value="Infaq" <?php if($data->sumber_dana == 'Infaq'){echo "selected";} ?>>Infaq</option>
                                              <option value="Shodaqoh" <?php if($data->sumber_dana == 'Shodaqoh'){echo "selected";} ?>>Shodaqoh</option>
                                              <option value="Wakaf" <?php if($data->sumber_dana == 'Wakaf'){echo "selected";} ?>>Wakaf</option>
                                            </select>
                                          </div>
                                        </fieldset>
                                      </div>
