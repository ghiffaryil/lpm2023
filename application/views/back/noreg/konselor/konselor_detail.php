                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($data->status == '0') { ?>
                                                                            <a href="<?php echo base_url('noreg/update_individu/' . $data->id_transaksi_individu) ?>" class="btn btn-success btn-sm"><span><i class="fa fa-pencil"></i> Edit</span></a>
                                                                            <a href="<?php echo base_url('noreg/delete_individu/' . $data->id_transaksi_individu) ?>" class="btn btn-danger btn-sm"><span><i class="fa fa-trash"></i> Delete</span></a>
                                                                        <?php } else { ?>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($detail_komunitas as $data) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($data->status == '0') { ?>
                                                                            <a href="<?php echo base_url('noreg/update_komunitas/' . $data->id_transaksi_komunitas) ?>" class="btn btn-success btn-sm"><span><i class="fa fa-pencil"></i> Edit</span></a>
                                                                            <a href="<?php echo base_url('noreg/delete_komunitas/' . $data->id_transaksi_komunitas) ?>" class="btn btn-danger btn-sm"><span><i class="fa fa-trash"></i> Delete</span></a>
                                                                        <?php } else { ?>
                                                                            <a class="btn btn-success btn-sm" disabled><span><i class="fa fa-pencil"></i> Edit</span></a>
                                                                        <?php } ?>
                                                                    </td>
