						...
						<div class="card">
							<div class="card-body">
								<div class="text-capitalize">
									<h2><b><?php echo $page_title . ' - ' . $get_all[0]->nama_komunitas ?></b></h2>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<a href="<?php echo base_url('komunitas/detail/' . $get_all[0]->id_komunitas) ?>" class="btn btn-primary text-capitalize"><i class="fa fa-eye"></i> Lihat Data Komunitas</a>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-6 text-capitalize">
										...
										<p class="d-block overflow-hidden"><?php echo $get_all[0]->bentuk_manfaat ?></p>
