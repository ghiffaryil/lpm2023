          ...
          <div class="row">
            <div class="col-lg-12">
              <fieldset class="form-group">
                <form action="<?php echo base_url('dashboard/index'); ?>" method="get">
            ...
            <?php } else { ?>
              ...
              <div class="col-lg-4">
                <?php if (!empty($user->photo)) { ?>
                  <img src="<?php echo base_url('assets/photo/'.$user->photo)?>" class="img-thumbnail" alt="photo" width="100%">
                <?php } else { ?>
              ...
              <div class="col-lg-8 align-self-left">
                  <table class="table nowrap" width="100%">
                      ...
                      <tr>
                          ...
                          <td align="right">
                            <?php echo "Rp. ".number_format(intval($total_individu->bantuan_individu)+intval($total_komunitas->bantuan_komunitas))?>
                          </td>
                      </tr>
                      <tr>
                          <th>Jumlah Pengajuan</th>
                          <td align="right">
                            <?php echo intval($total_individu[0]->pengajuan_individu)+intval($total_komunitas[0]->pengajuan_komunitas) ?> Kali
                          </td>
                      </tr>
                      <tr>
                          <th></th>
                ...
                <ul class="nav nav-tabs">
                              ...
                              <div class="tab-content mt-4">
                                <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                                  <div class="row">
                                      <table class="table table-striped nowrap text-capitalize search" width="100%">
                          <thead>
                                    <tr>
                                      <th width="5px">No</th>
                                      <th>Nama</th> 
                            ...
                            <?php 
                              $no += 1;
                                ...
                                <div class="tab-pane" id="tab2" aria-labelledby="base-tab2">
                                  <div class="row">
                                    <table class="table table-striped nowrap search" width="100%">
                        <thead>
                          <tr>
                                    <th width="5px">No</th>
                                    <th>Tanggal</th>
