											...
											<div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="row">
															<div class="col-lg-6">
																<h5>Rekap relawan per provinsi</h5>
													...
													<table id="tabel-individu" class="table table-striped nowrap" width="100%">
														<thead>
															<tr>
																...
																<th>Jumlah Penghasilan per Bulan (Awal)</th>
																...
																<th>Jumlah Penghasilan Setalah Program Berjalan</th>
														...
														<tbody>
															...
															foreach ($individu as $data) { ?>
																<tr>
																	...
																	<td>Rp. <?php echo $data->jumlah_penghasilan ?></td>
																	...
																	<td class="text-center">
																		<a href="<?php echo base_url('darling/detail_laporan_individu/' . $data->nik) ?>" class="btn btn-primary btn-sm" title="Detail"><span><i class="fa fa-eye"></i></span> </a>
																	</td>
																</tr>
															<?php
																$no += 1;
															...
															<div class="col-lg-6">
																...
																<table class="table table-bordered table-striped nowrap">
																	...
																	<tbody>
																		<tr>
																			<td>Total</td>
																			<td><?= $total_provinsi_komunitas; ?></td>
																			<td><?= $total_kab_kota_komunitas; ?></td>
																			<td>-</td>
																			<td><?= $total_pm_komunitas; ?></td>
																			<td><?= number_format($total_jumlah_bantuan_komunitas, 0, ',', '.'); ?></td>
																		</tr>
																	</tbody>
																</table>
															</div>
															<div class="col-lg-6">
																<h5>Kategori berdasarkan Sub Program</h5>
																<table class="table table-bordered table-striped nowrap">
																	<thead>
																		<tr>
																			<th>No</th>
														...
														<tbody>
															...
															foreach ($komunitas as $data) { ?>
																<tr>
																	...
																	<td>Rp. <?php echo number_format($data->jumlah_bantuan) ?></td>
																	<td>
																		<a href="<?php echo base_url('darling/detail_laporan_komunitas/' . $data->nik_transaksi) ?>" class="btn btn-primary btn-sm" title="Detail">
