                        ...
                        <div class="row">
                          <div class="col-md-6 mb-2">
                            ...
                            <fieldset class="form-group">
                              ...
                              <select type="text" class="form-control selectpicker" style="width: 100%"
                                ...
                                <fieldset class="form-group">
                                  <p>Sumber Dana</p>
                                  <input type="text" class="form-control text-capitalize" id="sumber_dana" name="sumber_dana" value="<?php echo $data->info_bantuan ?>">
                                </fieldset>
                          ...
                          <div class="col-md-6">
                            ...
                            <fieldset class="form-group ditolak">
                                  ...
                                  <input type="text" class="form-control text-capitalize mekanisme_bantuan"
                                    name="penghasilan_bulan" id="penghasilan_bulan" value="<?php echo $data->penghasilan_bulan ?>">
                               </fieldset>
