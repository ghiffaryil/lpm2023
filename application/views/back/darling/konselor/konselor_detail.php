									...
									<table width="100%">
										<tbody>
											<tr>
												...
												<td>Rp. <?php echo number_format(($data_individu[0]->jumlah_permohonan)+($data_komunitas[0]->jumlah_permohonan)) ?></td>
											</tr>
											<tr>
				                            	...
				                            	<table class="table table-striped nowrap text-capitalize datatable" width="100%">
													<thead>
														<tr>
															...
															<th>Penghasilan Setelah Di Bantu</th>
										                <th>Action</th>
														</tr>
														</thead>
							                    <tbody>
											            ...
											            <tr>
											                ...
											                <td>
											                	<?php if ($data->status == '0') { ?>
											                		<a href="<?php echo base_url('darling/update_individu/'.$data->id_transaksi_individu) ?>" class="btn btn-success btn-sm"><span><i class="fa fa-pencil"></i> Edit</span></a>
																	<a href="<?php echo base_url('darling/delete_individu/'.$data->id_transaksi_individu) ?>" class="btn btn-danger btn-sm"><span><i class="fa fa-trash"></i> Delete</span></a>
											                	<?php }else{ ?>
		                            ...
		                            <div class="tab-pane" id="tab2" aria-labelledby="base-tab2">
		                            	<div class="row">
			                            	<table id="datatable" class="table table-striped nowrap text-capitalize" width="100%">
							                    ...
							                    <tbody>
													<?php $no = 1; foreach($detail_komunitas as $data){ ?>
										            <tr>
										                <td><?php echo $no ?></td>
										                <td><?php echo date("d-m-Y", strtotime($data->tanggal_transaksi)) ?></td>
														<td><?php echo strtolower($data->nama_rekomender) ?></td>
												        ...
												        <td>
											                <?php if ($data->status == '0') { ?>
											                	<a href="<?php echo base_url('darling/update_komunitas/'.$data->id_transaksi_komunitas) ?>" class="btn btn-success btn-sm"><span><i class="fa fa-pencil"></i> Edit</span></a>
																<a href="<?php echo base_url('darling/delete_komunitas/'.$data->id_transaksi_komunitas) ?>" class="btn btn-danger btn-sm"><span><i class="fa fa-trash"></i> Delete</span></a>
											                <?php }else{ ?>
											                	<a class="btn btn-success btn-sm" disabled><span><i class="fa fa-pencil"></i> Edit</span></a>
											               	<?php } ?>	   	
											            </td>
