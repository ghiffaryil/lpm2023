                                    ...
                                    <table id="datatable" class="table table-striped table-bordered nowrap" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($get_all_deleted as $data) {
                                                // action
                                                $restore = '<a href="' . base_url('kategori_komunitas/restore/' . $data->id_kategori_komunitas) . '" class="btn btn-sm btn-warning"><i class="fa fa-refresh"></i></a>';
                                                $delete = '<a href="' . base_url('kategori_komunitas/delete_permanent/' . $data->id_kategori_komunitas) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i></a>';
                                            ?>
                                                <tr>
                                                    <td><?php echo $no++ ?></td>
