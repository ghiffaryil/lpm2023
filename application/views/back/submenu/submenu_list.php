          ...
          <div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-striped table-bordered nowrap" width="100%">
                      ...
                      <th style="text-align: center">SubMenu URL</th>
                      ...
                      <th style="text-align: center">Action</th>
						...
						<?php $no = 1; foreach($get_all as $data){
			                  // action
			                  $edit = '<a href="'.base_url('submenu/update/'.$data->id_submenu).'" class="btn btn-sm btn-warning"><i class="ft-edit"></i></a>';
			                  $delete = '<a href="'.base_url('submenu/delete/'.$data->id_submenu).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>';
			                ?>
			                  <tr>
