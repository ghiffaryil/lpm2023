              ...
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item">
                  ...
                  <div ngbdropdownmenu="" aria-labelledby="dropdownBasic3" class="dropdown-menu text-left dropdown-menu-right">
                    <a href="<?php echo base_url('auth/update_profile/' . $this->session->id_users) ?>" class="dropdown-item py-1">
                      <i class="ft-camera mr-2"></i>
                      <span>Update Profile</span>
                    </a>
                    <a href="<?php echo base_url('auth/change_password') ?>" class="dropdown-item py-1">
                      <i class="ft-lock mr-2"></i>
                      <span>Ganti Password</span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="<?php echo base_url('auth/logout') ?>" class="dropdown-item">
                      <i class="ft-power mr-2"></i><span>Keluar</span>
                    </a>
                  </div>
                </li>
              </ul>
