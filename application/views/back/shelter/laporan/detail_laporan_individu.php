			...
			<section class="">
				<div class="row">
					<div class="col-sm-12">
						<div class="card">
							<div class="card-body">
								<div class="text-capitalize"><h1><b><?php echo $page_title.' - '.$get_all[0]->nama?></b></h1></div>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card-body"> 
								<div class="row">
									<div class="col-md-6 text-capitalize">
										<p class="text-bold-500 primary"><a><i class="ft ft-user"></i> Nama Penerima Manfaat (Pasien)</a></p>
										...
										<p class="text-bold-500 primary"><a><i class="ft ft-calendar"></i> Penyakit</a></p>
										<p class="d-block overflow-hidden"><?php echo $get_all[0]->penyakit ?></p>
									</div>
									<div class="col-md-6 text-capitalize">
								...
								<div class="row">
									<div class="col-md-6 text-capitalize">
										...
										<p class="text-bold-500 primary"><a><i class="ft ft-briefcase"></i> Nama Sub Program </a></p>
