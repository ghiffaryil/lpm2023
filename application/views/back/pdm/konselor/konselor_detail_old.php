				                            	...
				                            	<table class="table table-striped nowrap text-capitalize datatable" width="100%">
								                    ...
								                    <tbody>
											            ...
											            <tr>
											                ...
											                <td><?php echo $data->info_bantuan ?></td>
											                ...
											                <td>
											                	<?php if ($data->status == '0') { ?>
																	...
																	<a href="<?php echo base_url('brp/delete/'.$data->id_transaksi_individu) ?>" class="btn btn-danger btn-sm"><span><i class="fa fa-trash"></i> Delete</span></a>
											                	<?php }else{ ?>
