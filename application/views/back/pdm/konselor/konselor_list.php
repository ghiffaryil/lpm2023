						...
						<div class="card">
							<div class="card-body">
								...
								<div class="tab-content mt-4">
									...
									<div class="row">
									<table id="tabel-individu" class="table table-striped nowrap"
									width="100%">
									<thead>
										<tr>
										...
										<?php $no = 1; foreach($individu as $data){ ?>
											<tr>
												...
												<td><?php echo $data->nama_rekomender ?></td>
													<td class="bg-white">
														<a href="<?php echo base_url('pdm/detail_konselor/'.$data->nik) ?>" class="btn btn-primary btn-sm" title="Detail"><i class="fa fa-eye"></i></a>
														<a href="<?php echo base_url('pdm/update_individu/'.$data->id_transaksi_individu) ?>" class="btn btn-success btn-sm" title="Edit"><span><i class="fa fa-pencil"></i> </span></a>
														<a href="<?php echo base_url('pdm/delete_individu/'.$data->id_transaksi_individu) ?>" class="btn btn-danger btn-sm" title="Delete"><span><i class="fa fa-trash"></i></span></a>
													</td>
												</tr>
												<?php 
												$no += 1;
									...
									<tbody>
										<?php $no = 1; foreach($komunitas as $data){ ?>
											<tr>
												...
												<td><?php echo $data->total_periode ?></td>
												<td><?php echo $data->nama_rekomender ?></td>												
												<td><?php echo $data->nik_pasien ?></td>
												...
												<td class="bg-white">
													<a href="<?php echo base_url('pdm/detail_konselor/'.$data->nik) ?>" class="btn btn-primary btn-sm" title="Detail"><i class="fa fa-eye"></i></a>
													<a href="<?php echo base_url('pdm/update_komunitas/'.$data->id_transaksi_komunitas) ?>" class="btn btn-success btn-sm" title="Edit"><span><i class="fa fa-pencil"></i> </span></a>
																<a href="<?php echo base_url('pdm/delete_komunitas/'.$data->id_transaksi_komunitas) ?>" class="btn btn-danger btn-sm" title="Delete"><span><i class="fa fa-trash"></i> </span></a>
												</td>
											</tr>
											<?php 
											$no += 1;
											...
											<div class="modal-body">
									        	...
									        	<tbody>
												      ...
												      <tr>
												        ...
												        <td class="p-1">
												          <a href="<?php echo base_url('pdm/create/').$data->nik ?>" class="btn btn-sm btn-success" title="Tambah Manfaat"><i class="fa fa-plus-circle"></i> Tambah</a>
												        </td>
												      </tr>
															<?php 
																$no += 1;
