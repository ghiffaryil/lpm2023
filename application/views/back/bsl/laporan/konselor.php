															...
															foreach ($individu as $data) { ?>
																<tr>
																	...
																	<td class="text-center">
																		<a href="<?php echo base_url('bsl/detail_laporan_individu/' . $data->nik) ?>" class="btn btn-primary btn-sm" title="Detail"><span><i class="fa fa-eye"></i></span> </a>
																	</td>
																</tr>
															<?php
																$no += 1;
											...
											<div class="tab-pane" id="tab2" aria-labelledby="base-tab2">
												<div class="row">
													...
													<div class="col-lg-12">
														<div class="row">
															<div class="col-lg-6">
																<h5>Rekap berdasarkan Lapas</h5>
																<table class="table table-bordered">
																	<thead class="thead-light">
																		<tr>
																			<th>No</th>
																			<th>Lapas</th>
																			<th>Jumlah WBP Laki-Laki</th>
																			<th>Jumlah WBP Perempuan</th>
																			<th>Jumlah WBP</th>
																		</tr>
																	</thead>
																	<tbody>
																		<?php $i = 1;
																		foreach ($total_lapas_jk as $row) : ?>
																			<tr>
																				<td><?= $i; ?></td>
																				<td><?= $row['lapas'] ?></td>
																				<td><?= $row['jk_l'] ?></td>
																				<td><?= $row['jk_p'] ?></td>
																				<td><?= $row['jumlah_wbp']  ?></td>
																			</tr>
																		<?php $i++;
																		endforeach; ?>
																	</tbody>
															...
															<div class="col-lg-6">
																...
																<table class="table table-bordered">
																	...
																	<tbody>
																		<?php $i = 1;
																		foreach ($total_kasus as $row) : ?>
																			<tr>
																				<td><?= $i; ?></td>
																				<td><?= $row['jenis_pidana'] ?></td>
																				<td>-</td>
																				<td><?= $row['jumlah_wbp']  ?></td>
																			</tr>
																		<?php $i++;
														...
														<tbody>
															...
															foreach ($komunitas as $data) { ?>
																<tr>
																	...
																	<td>
																		<a href="<?php echo base_url('bsl/detail_laporan_komunitas/' . $data->nik_transaksi) ?>" class="btn btn-primary btn-sm" title="Detail">
