                      ...
                      <div class="form-body">
                        <div class="row">
                          <div class="col-md-6 mb-2">
                            ...
                            <fieldset class="form-group">
                              <p>Nama Sekolah</p>
                              <input type="text" class="form-control text-capitalize" id="sekolah_nama"
                                name="sekolah_nama" value="<?php echo $data->sekolah_nama ?>">
                            </fieldset>
                            <div class="row">
                              <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            ...
                            <fieldset class="form-group mb-1">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" oninput="formatValue('jumlah_bantuan')" id="jumlah_bantuan"
                                  name="jumlah_bantuan" class="form-control"
                                  value="<?php echo number_format($data->jumlah_bantuan) ?>"
                            ...
                            <fieldset class="form-group">
                              <p>Alamat</p>
                              <textarea type="text" rows="1" class="form-control text-capitalize" id="sekolah_alamat"
                                name="sekolah_alamat"><?php echo $data->sekolah_alamat ?></textarea>
                            </fieldset>
                            <fieldset class="form-group">
                              <p>Keterangan</p>
