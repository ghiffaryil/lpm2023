                          ...
                          <div class="form-body">
                            ...
                            <div class="row">
                              <div class="col-md-6 mb-2">
                                ...
                                <?php if ($data->jk == 'P') { ?>
                                  ...
                                  <div class="custom-control custom-checkbox custom-control-inline ml-1">
                                    <input type="radio" id="status_pernikahan" name="status_pernikahan"
                                      class="custom-control-input" value="Janda">
                                    <label class="custom-control-label" for="status_pernikahan">
                                      Janda
                                    </label>
                                  </div>
                                  <div class="custom-control custom-checkbox custom-control-inline ml-1">
                                    <input type="radio" id="status_pernikahan2" name="status_pernikahan"
                                      class="custom-control-input" value="Bukan Janda">
                                    <label class="custom-control-label" for="status_pernikahan2">
                                      Bukan Janda
                                    </label>
                                  </div>
                                </fieldset> -->
                                ...
                                <fieldset class="form-group">
                                  <p>Nama Sekolah</p>
                                  <input type="text" class="form-control text-capitalize" id="sekolah_nama" name="sekolah_nama">
                                </fieldset>
                                <div class="row">
                                  <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                ...
                                <fieldset class="form-group">
                                  <p>Alamat</p>
                                  <textarea type="text" rows="1" class="form-control text-capitalize" id="sekolah_alamat" name="sekolah_alamat"></textarea>
                                </fieldset>
                                <?php if ($cek_individu == 0) { ?>
                                  <?php $ket = "PM Baru" ?>
                                <?php } else { ?>
                                ...
                                <fieldset class="form-group">
                                  <p>Keterangan</p>
                                  <input type="text" class="form-control text-capitalize" id="keterangan" name="keterangan" value="<?php echo $ket ?>" readonly>
                                </fieldset>
