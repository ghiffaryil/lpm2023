  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data) {
        ...
        alert("Belum ada Kota pada provinsi ini");
      }
      $("#kota").html(option);
    },
  });
...
function ajaxkec(id) {
  document.getElementById("kec").removeAttribute("disabled");
  let idKota = id;
  $.ajax({
    type: "GET",
    url: "getKec",
    ...
    success: function (data) {
      ...
      if (data) {
        ...
        alert("Belum ada kecamatan pada kota ini");
      }
      $("#kec").html(option);
    },
  });
...
function ajaxkel(id) {
  document.getElementById("kel").removeAttribute("disabled");
  let idKec = id;
  $.ajax({
    type: "GET",
    url: "getKel",
    ...
    success: function (data) {
      ...
      if (data) {
        ...
        alert("Belum ada Kelurahan pada kota ini");
      }
      $("#kel").html(option);
    },
  });
...
function showCoordinate() {
  ...
  var s =
    kel.options[kel.selectedIndex].text +
    ", " +
